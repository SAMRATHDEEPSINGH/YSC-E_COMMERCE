...
import { selectAllProducts, fetchAllProductAsync, fetchProductsByFiltersAsync, selectTotalItems, selectBrands, selectCategories, fetchBrandsAsync, fetchCategoriesAsync } from '../../features/Product/ProductSlice'
...
export default function AdminProductList() {
  ...
  const handleFilter = (e, section, option) => {
    ...
    if (e.target.checked) {
      ...
      const index = newFilter[section.id].findIndex(element => element === option.value)
        ...
        <div className="bg-white">
          <div>
            ...
            <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                  ...
                  <div className="mt-auto">
                    ...
                    to='/admin/product-form'
                      type="button"
                      className="rounded-md mx-8 my-5 bg-orange-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                    >
                      Add New Product
                    </Link>
              ...
              {/* Pagination */}
              <Pagination page={page} setPage={page} handlePage={handlePage} totalItems={totalItems}></Pagination>
            </main>
          </div>
        </div>
            ...
            {products.map((product) => (
              <div key={product.id} className="flex flex-col h-full">
                <Link to={`/product-detail/${product.id}`}>
                  <div className="group relative border-solid border-2 p-2 border-gray-200 flex flex-col h-full">
                    ...
                    {product.stock<=0 &&
                    <div>
                      <p className='text-sm text-red-500'>Product Deleted(Out Of Stock)</p>
                    </div>}
                  </div>
                </Link>
                <div className="mt-5">
