...
import { fetchLoggedInUserOrdersAsync, selectedOrder,selectedInfo } from '../../features/User/userSlice'
...
<div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    <h1 className="text-4xl my-5 font-bold tracking-tight text-gray-900">Order No #{order.id}</h1>
          ...
          <li key={item.id} className="flex py-6">
            ...
            <div className="ml-4 flex flex-1 flex-col">
              ...
              <div className="flex flex-1 items-end justify-between text-sm">
                <div className="text-gray-500"><label htmlFor="quantity" className="inline mr-2 text-sm font-medium leading-6 text-gray-900">
                Qty :{item.quantity}
                  </label> 
