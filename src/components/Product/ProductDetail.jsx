...
import { selectedProduct,fetchProductByIdAsync,selectedStatus } from '../../features/Product/ProductSlice';
...
export default function ProductDetail() {
  ...
  const newItems={...product,productID:product.id,quantity:1,user:user.id}
  delete newItems['id'];
  dispatch(addToCartAsync(newItems));
  showAlert('Product Added Successfully','success')
    }else{
      showAlert('Product is Already Added in Cart','info')
    }
